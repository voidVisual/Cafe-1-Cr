    ...
    <div className="flex h-full w-64 flex-col bg-white border-r border-gray-200">
      ...
      <div className="border-t border-gray-200 p-4">
        <button
          ...
          className="group flex w-full items-center px-3 py-2.5 text-sm font-medium rounded-md text-gray-700 hover:bg-gray-50 hover:text-gray-900 transition-colors"
        >
